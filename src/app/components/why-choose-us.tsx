        ...
        <section className="relative w-full min-h-[110vh] overflow-hidden flex items-center justify-center px-4 py-20">
            ...
            <div className="relative w-full max-w-4xl h-96 md:h-[500px] flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-[35vw] h-[65vh] 2xl:w-[600px] 2xl:h-[600px] rounded-full bg-linear-to-br from-white via-white to-[#A1A1A14D] flex flex-col items-center justify-center shadow-2xl">
                        <div className="text-center px-0 flex flex-col -space-y-6 2xl:-space-y-6">
                            <div className="text-[25px] md:text-[35px] 2xl:text-[40px] uppercase text-black font-medium">70% Better User </div>
                            <div className="text-[25px] md:text-[65px] 2xl:text-[80px] uppercase font-bold text-black">Experience</div>
                            <div className="text-[25px] md:text-[35px] 2xl:text-[35px] uppercase text-black mt-2 font-medium">(Based on UX Score Metrics)</div>
                ...
                <div
                    className="absolute top-[-10%] left-[-20%] 2xl:left-[-300px] w-[250px] h-[250px] 2xl:w-[370px] 2xl:h-[370px] flex items-center justify-center shadow-lg bg-contain bg-center bg-no-repeat"
                ...
                <div className="absolute top-[-20%] right-[-20%] 2xl:right-[-300px] w-[300px] h-[300px] 2xl:w-[400px] 2xl:h-[400px] rounded-full bg-linear-to-br to-[#113D49] from-[#37C7EF] flex items-center justify-center shadow-lg">
                    <div className="text-center px-4 flex flex-col space-y-4">
                ...
                <div
                    className="absolute bottom-[-20%] 2xl:bottom-[-55%] left-[-20%] 2xl:left-[-30%] w-[290px] h-[290px] 2xl:w-[370px] 2xl:h-[370px] flex items-center justify-center shadow-lg bg-cover bg-center bg-no-repeat"
                ...
                <div className="absolute bottom-[-20%] 2xl:bottom-[-45%] right-[-20%] 2xl:right-[-250px] w-[300px] h-[300px] 2xl:w-[350px] 2xl:h-[350px] rounded-full bg-linear-to-br to-[#193B6E3B] from-[#193B6E] flex items-center justify-center shadow-lg">
                    <div className="text-center px-4 flex flex-col space-y-4">
